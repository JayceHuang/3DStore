...
public final class ImageSizeUtils {
	 ...
	 * 由public方法改成private方法
	 * 
	 * */
	private static ImageSize defineTargetSizeForView(ImageAware imageAware, ImageSize maxImageSize) {
	...
	/**
	 * add by sven.zhan	 * 
	 * 以DisplayImageOptions的默认空图大小作为ImageSize;
	 */
	public static ImageSize defineTargetSizeForView(Resources resources,DisplayImageOptions options,ImageAware imageAware, ImageSize maxImageSize) {
		Drawable drawable = options.getImageForEmptyUri(resources);
		if(drawable != null){
			int width = drawable.getIntrinsicWidth();
			int height = drawable.getIntrinsicHeight();
			return new ImageSize(width, height);
		}else{
			return defineTargetSizeForView(imageAware, maxImageSize);
		}
	}
