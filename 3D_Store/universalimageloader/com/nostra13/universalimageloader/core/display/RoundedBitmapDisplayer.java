...
public class RoundedBitmapDisplayer implements BitmapDisplayer {
	...
	private RoundedBitmapDisplayer(int cornerRadiusPixels, int marginPixels) {
	...
	public void display(Bitmap bitmap, ImageAware imageAware, LoadedFrom loadedFrom) {
		...
		View imagview = imageAware.getWrappedView();
		if(imagview instanceof ImageView){
			drawable.setScaleType(((ImageView)imagview).getScaleType());
		}
		imageAware.setImageDrawable(drawable);
	}

	/** 原框架的RoundedDrawable 有bug*
