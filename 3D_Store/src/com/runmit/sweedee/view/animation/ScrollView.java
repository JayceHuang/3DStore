...
public class ScrollView extends FrameLayout{
	...
	public void setOnScrollStateChangeListener(OnScrollStateChangeListener mOnScrollStateChangeListener) {
		this.mOnScrollStateChangeListener = mOnScrollStateChangeListener;
	}
    ...
    void reportScrollStateChange(int newState) {
        if (newState != mLastScrollState) {
            if (mOnScrollStateChangeListener != null) {
                ...
                mOnScrollStateChangeListener.onScrollStateChanged(newState);
            }
        }
    }
    ...
    protected float getVerticalScrollFactor() {
        ...
        return outValue.getDimension(mContext.getResources().getDisplayMetrics());
    }
    ...
    public final void smoothScrollBy(int dx, int dy) {
        ...
        if (duration > ANIMATED_SCROLL_GAP) {
            ...
            final int scrollY = getScrollY();
            int deltay = Math.max(0, Math.min(scrollY + dy, maxY)) - scrollY;
            mScroller.startScroll(getScrollX(), scrollY, 0, deltay,400);
            reportScrollStateChange(OnScrollListener.SCROLL_STATE_TOUCH_SCROLL);
            invalidate();
        } else {
            if (!mScroller.isFinished()) {
    ...
    interface OnScrollStateChangeListener {
    	/**
    	 * 
    	 *	@param scrollState The current scroll state. One of {@link #AbsListView.OnScrollListener.SCROLL_STATE_IDLE},
