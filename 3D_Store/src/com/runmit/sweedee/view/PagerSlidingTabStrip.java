...
/**
 * pstsindicatorcolor滑动指示器 pstsunderlinecolor在视图的底部的全宽度的线
 * pstsdividercolor选项卡之间的分隔颜色 pstsindicatorheightheight滑动指示器
 * pstsunderlineheight在视图的底部的全宽度的线高度 pstsdividerpadding顶部和底部填充的分频器
 * pststabpaddingleftright左、右填充每个选项卡 pstsscrolloffset卷轴被选择的标签的偏移
 * pststabbackground背景绘制的每个标签，应该是一个statelistdrawable
 * pstsshouldexpand如果设置为TRUE，每个标签都给予同样的权重，默认为true
