 ...
 */
public class DirectListView extends AdapterView<ListAdapter> implements
    ...
    public interface OnScrollListener {
         ...
         */
        public void onScrollStateChanged(DirectListView view, int scrollState);
         ...
         */
        public void onScroll(DirectListView view, int firstVisibleItem, int visibleItemCount,
                             int totalItemCount);
    }
     ...
     *
     * @see DirectListView.RecycleBin
     * @see DirectListView#setRecyclerListener(DirectListView.RecyclerListener)
     */
    ...
    public DirectListView(Context context, AttributeSet attrs) {
    ...
    public DirectListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDrawSelectorOnTop = a.getBoolean(
                R.styleable.DirectListView_android_drawSelectorOnTop, false);
     ...
     *                 in the recycler.
     * @see DirectListView.RecycleBin
     * @see DirectListView.RecyclerListener
     */
...
//            mDataChanged = true;
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (listener != null) {
                handled = listener.onItemLongClick(DirectListView.this, originalView,
                ...
                switch (mTouchMode) {
                    ...
                    case TOUCH_MODE_DRAGGING:
                        ...
                        if (Math.abs(velocity) >= mFlingVelocity) {
                            ...
                            mScroller.fling(0, 0,(int) (mIsVertical ? 0 : velocity),(int) (mIsVertical ? velocity : 0),(mIsVertical ? 0 : Integer.MIN_VALUE),(mIsVertical ? 0 : Integer.MAX_VALUE),(mIsVertical ? Integer.MIN_VALUE : 0),(mIsVertical ? Integer.MAX_VALUE : 0));
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(DirectListView.class.getName());
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setClassName(DirectListView.class.getName());
...
//    }
    ...
    private boolean performLongPress(final View child,
        ...
        OnItemLongClickListener listener = getOnItemLongClickListener();
        if (listener != null) {
            handled = listener.onItemLongClick(DirectListView.this, child,
                    longPressPosition, longPressId);
        }
    ...
    private class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (DirectListView.this.mHasStableIds && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                DirectListView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (DirectListView.this.mHasStableIds) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = DirectListView.this.onSaveInstanceState();
            }
    ...
    static class SavedState extends BaseSavedState {
        ...
        /**
         * Constructor called from {@link DirectListView#onSaveInstanceState()}
         */
    ...
    private static class ArrowScrollFocusResult {
        ...
        /**
         * How {@link DirectListView#arrowScrollFocused} returns its values.
         */
