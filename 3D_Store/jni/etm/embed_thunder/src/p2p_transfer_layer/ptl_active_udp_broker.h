...
created:	2009/07/20
-----------------------------------------------------------------------------------------------------------*/
#ifndef _PTL_ACTIVE_UDP_BROKER_H_
#define _PTL_ACTIVE_UDP_BROKER_H_
#ifdef __cplusplus
extern "C" 
{
#endif
...
typedef struct tagACTIVE_UDP_BROKER_DATA
{
...
}ACTIVE_UDP_BROKER_DATA;

_int32 ptl_active_udp_broker_data_comparator(void *E1, void *E2);

_int32 ptl_init_active_udp_broker(void);

_int32 ptl_uninit_active_udp_broker(void);

_int32 ptl_active_udp_broker(struct tagPTL_DEVICE* device, const char* remote_peerid);
...
_int32 ptl_erase_active_udp_broker_data(struct tagACTIVE_UDP_BROKER_DATA* data);
